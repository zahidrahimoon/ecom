...
<body class="bg-gray-100">
    ...
    @include('components.pagehero', ['title' => 'Edit Appointment'])

    <main>
        <article>
            <!-- Booking Form Section -->
            <div class="container mx-auto mt-10">
                <h1 class="text-9xl font-extrabold text-gray-800 text-shadow-custom text-center pt-9 mb-[-100px]">Edit Appointment</h1>
                    ...
                    <div class="w-full md:w-1/2 bg-white p-8 shadow-lg rounded-lg border-4 border-green-500"
                        ...
                        <form action="{{ route('bookings.update', $booking) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="hospital_name" value="{{ $booking->hospital_name }}"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="hospital_address" value="{{ $booking->hospital_address }}"
                                    class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="customer_mobile_number" value="{{ $booking->customer_mobile_number }}"
                                    class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                            ...
                            <div class="mb-6">
                                ...
                                <select name="type"
                                    class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                                    required>
                                    <option value="Emergency" {{ $booking->type == 'Emergency' ? 'selected' : '' }}>Emergency</option>
                                    <option value="Non-Emergency" {{ $booking->type == 'Non-Emergency' ? 'selected' : '' }}>Non-Emergency</option>
                                </select>
                            </div>
                            <!-- Submit Button -->
                            <button type="submit"
