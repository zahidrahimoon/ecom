...
<body class="bg-gray-50 dark:bg-gray-900 font-oswald">
    <section class="flex flex-col md:flex-row h-screen">
        ...
        <div class="w-full md:w-2/3 bg-gray-800 dark:bg-gray-900 flex items-center justify-center">
            <img src="https://media.gettyimages.com/id/1312706413/photo/modern-hospital-building.jpg?s=612x612&w=0&k=20&c=oUILskmtaPiA711DP53DFhOUvE7pfdNeEK9CfyxlGio=" alt="logo" class="w-full h-full object-cover">
        </div>
        ...
        <div class="w-full md:w-1/3 flex items-center justify-center bg-gray-100 dark:bg-gray-800">
            <div class="w-full max-w-md p-6 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-900 dark:border dark:border-gray-700">
                ...
                <!-- Display Flash Error for Incorrect Credentials -->
                @if (session('error'))
                    <div class="bg-red-500 text-white p-3 rounded-lg">
                        {{ session('error') }}
                    </div>
            ...
            <div class="flex flex-col ml-5 space-y-2 mt-6">
                ...
                <a href="{{ route('driver.login') }}" class="w-full text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
