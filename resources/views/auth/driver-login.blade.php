...
<body class="bg-gray-50 dark:bg-gray-900 font-oswald">
    <section class="flex flex-col md:flex-row h-screen">
        ...
        <div class="w-full md:w-2/3 bg-gray-800 dark:bg-gray-900 flex items-center justify-center">
            <img src="https://media.gettyimages.com/id/1279524016/photo/portrait-of-happy-paramedic-man-with-arms-crossed-in-front-of-ambulance.jpg?s=612x612&w=0&k=20&c=vxObLVJnb_-cw2hAhpxVuIZkBMHd4W0ij_Hlz2w9xl8=" alt="logo" class="w-full h-full object-cover">
        </div>
